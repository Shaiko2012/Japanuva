...
export const dailyItinerary: DayPlan[] = [
  {
    ...
    activities: ["נחיתה ב-NRT", "Suica במכונה", "ערב רגוע בשינג'וקו"],
    transitMinutes: 70,
    transitLabel: "N'EX / Skyliner לשינג'וקו",
  },
  {
    id: "d2",
    date: "2027-10-06",
  ...
  },
  {
    ...
    city: "טוקיו",
    districtId: "shinjuku",
    accommodation: { name: "Hotel Nikko Narita", status: "pending" },
    tags: ["מעבר", "JR Pass", "מנוחה"],
    activities: ["אוסקה→טוקיו", "מלון ליד הנמל", "ארגון YCAT"],
    transitMinutes: 155,
    transitLabel: "שינקנסן + העברה ל-NRT",
  },
  {
    id: "d15",
    date: "2027-10-19",
